...
Flat shell scripts create the local environment and schedule those commands for
a particular machine. Durable outputs use the same number and name under

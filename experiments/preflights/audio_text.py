...
def frozen_contract() -> FrozenContract:
    ...
    if reference.release is None:
        raise ValueError("the audio-text reference requires a release")
    ...
    *,
    ...
    return JobConfig(
        ...
        data=data(
            ...
            "experiments.preflights.audio_text:AudioTextRetrievalCollator",
        ),
        ...
        evaluation=EvaluationConfig(
            data=data(
                ...
                "experiments.preflights.audio_text:AudioTextEvaluationCollator",
            ),
...
def _pair(arguments: argparse.Namespace) -> None:
    ...
    for framework in FRAMEWORKS:
        ...
        command = [
            sys.executable,
            "-m",
            "experiments.preflights.audio_text",
            "worker",
            "--framework",
            framework,
            "--checkpoint",

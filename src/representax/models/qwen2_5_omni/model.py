...
class Qwen2_5OmniBatch(eqx.Module):
    ...
    input_features: Float[Array, "chunk mel feature"] | None = None
    audio_feature_valid: Bool[Array, "chunk feature"] | None = None
    audio_after_cnn_valid: Bool[Array, "chunk cnn_sequence"] | None = None
    audio_pool_indices: Int[Array, "audio_token pair"] | None = None
        ...
        *,
        ...
        if inputs.input_features is not None:
            ...
            audio = self.audio(
                ...
                inputs.audio_feature_valid,
                inputs.audio_after_cnn_valid,
                inputs.audio_pool_indices,
